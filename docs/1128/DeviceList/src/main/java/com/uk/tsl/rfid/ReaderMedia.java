...
public class ReaderMedia
{
    ...
    public static int listImageFor(Reader reader)
    {
        ...
        if( model.contentEquals("3166")) return R.drawable.list_3166;
        if( model.contentEquals("3128")) return R.drawable.list_3128;

        if( model.contentEquals("3066")) return R.drawable.list_3066;
    ...
    public static int descriptionFor(Reader reader)
    {
        ...
        if( model.contentEquals("3166")) return R.string.description_3166;
        if( model.contentEquals("3128")) return R.string.description_3128;

        if( model.contentEquals("3066")) return R.string.description_3066;
