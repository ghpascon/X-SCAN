...
import com.uk.tsl.rfid.samples.configurebarcode.databinding.ActivityConfigureBarcodeBinding;
...
public class ConfigureBarcodeActivity extends AppCompatActivity
{
    // Debug control
    private static final String TAG = "BarcodeConfAct";
    private static final boolean D = BuildConfig.DEBUG;

    private AppBarConfiguration appBarConfiguration;
    private ActivityConfigureBarcodeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Now build the UI
        binding = ActivityConfigureBarcodeBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.toolbar);

        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_configure_barcode);
