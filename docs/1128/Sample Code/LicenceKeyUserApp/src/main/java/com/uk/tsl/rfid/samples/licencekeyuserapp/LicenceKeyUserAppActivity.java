...
import com.uk.tsl.rfid.samples.licencekeyuserapp.databinding.ActivityLicenceKeyUserAppBinding;
...
public class LicenceKeyUserAppActivity extends AppCompatActivity
{
    // Debug control
    private static final String TAG = "LKUserAppActivity";
    private static final boolean D = BuildConfig.DEBUG;


    private AppBarConfiguration appBarConfiguration;
    private ActivityLicenceKeyUserAppBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        binding = ActivityLicenceKeyUserAppBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.toolbar);

        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_licence_key_user_app);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.connect_reader_menu_item ) {
    ...
    private final String[] bluetoothPermissions = new String[] {android.Manifest.permission.BLUETOOTH_CONNECT, android.Manifest.permission.BLUETOOTH_SCAN};
    ...
    void offerBluetoothPermissionRationale()
    {
        ...
        builder.setPositiveButton("Show Permission Dialog", new DialogInterface.OnClickListener() {
            ...
            {
                requestPermissionLauncher.launch(new String[] {android.Manifest.permission.BLUETOOTH_CONNECT, Manifest.permission.BLUETOOTH_SCAN});
            }
        });
