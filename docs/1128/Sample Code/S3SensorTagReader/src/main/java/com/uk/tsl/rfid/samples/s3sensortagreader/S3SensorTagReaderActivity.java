...
import com.uk.tsl.rfid.samples.s3sensortagreader.databinding.ActivityS3SensorTagReaderBinding;
...
public class S3SensorTagReaderActivity extends AppCompatActivity
{
    private static final boolean D = BuildConfig.DEBUG;

    private AppBarConfiguration appBarConfiguration;
    private ActivityS3SensorTagReaderBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        binding = ActivityS3SensorTagReaderBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.toolbar);

        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_s3_sensor_tag_reader);
