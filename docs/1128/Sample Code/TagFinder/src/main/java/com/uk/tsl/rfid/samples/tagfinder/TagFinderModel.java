...
package com.uk.tsl.rfid.samples.tagfinder;
...
public class TagFinderModel extends ModelBase {
     ...
     */
    public ISignalStrengthCountDelegate getSignalStrengthCountDelegate() { return mSignalStrengthResponder.getSignalStrengthCountDelegate(); }

    /**
     * @param delegate the delegate for the signal strength transponder count delegate
     */
    public void setSignalStrengthCountDelegate(ISignalStrengthCountDelegate delegate) { mSignalStrengthResponder.setSignalStrengthCountDelegate(delegate); }
            ...
            else
            {
                ...
                if (mUseFindTagCommand)
                {
                    ...
                    if (!StringHelper.isNullOrEmpty(mTargetTagEpc) && mEnabled)
                    {
                        ...
                        mFindTagCommand.setTriggerOverride(StartStop.START);
                    }
                    else
                    {
