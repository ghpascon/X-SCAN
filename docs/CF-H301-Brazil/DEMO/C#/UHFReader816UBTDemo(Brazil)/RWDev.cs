...
namespace UHF
{
    ...
    {
        private const string DLLNAME = @"UHFReader816UBT.dll";
        ...
        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int SetWorkTime(ref byte ComAdr,
                                           byte FreeTime,
                                           byte TrigReadTime,
                                           int frmComPortindex);

        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int GetWorkTime(ref byte ComAdr,
                                           ref byte FreeTime,
                                           ref byte TrigReadTime,
                                           int frmComPortindex);
