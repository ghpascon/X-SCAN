...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.do_read) {
            rfidHandler.doRead();
        } else if (id == R.id.do_write) {
            rfidHandler.doWrite();
        } else if (id == R.id.add_singulation) {
            rfidHandler.setSingulationControl();
        } else if (id == R.id.add_trigger) {
            rfidHandler.triggerSettings();
        } else if (id == R.id.del_selects) {
            rfidHandler.deleteSelects();
        } else if (id == R.id.do_lock) {
            rfidHandler.doLock();
        } else if (id == R.id.set_start_trigger) {
            rfidHandler.setstarttrigger();
        } else if (id == R.id.set_stop_trigger) {
            rfidHandler.setstoptrigger();
        } else if (id == R.id.do_kill) {
            rfidHandler.doKill();
        }
